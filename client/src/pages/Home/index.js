    ...
    <>
      ...
      <Container className="bot-banner-container">
        ...
        <div className="bot-info-text">
          ...
          <p>Users from all over the US use The Business Connect Network to match with the highest rated services in their area. 
             Signup now to get connected with amazing businesses today.</p>
        </div>
      </Container>
